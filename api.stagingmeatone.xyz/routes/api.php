...
//    Route::get('/login/{provider}',                 [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::group(['prefix' => 'user', 'middleware' => ['sanctum.check'], 'as' => 'user.'], function () {
            ...
            Route::post('payments/create', [TapPaymentController::class, 'orderProcessTransaction']);
            Route::post('payments/webhook', [TapPaymentController::class, 'paymentWebHook'])->name('payment.webhook');
            Route::get('payments/success', [TapPaymentController::class, 'orderResultTransaction'])->name('payment.success');
            Route::get('payments/charge/{id}', [TapPaymentController::class, 'getCharge']);
...
//            Route::get('order-paypal-process', [Payment\PayPalController::class, 'orderProcessTransaction']);
    ...
    Route::group(['prefix' => 'points'], function () {
        Route::post('earn', [PointTransactionController::class, 'earnPoints']);
        Route::post('redeem', [PointTransactionController::class, 'redeemPoints']);
    });
});
